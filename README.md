![𝔸𝐧𝐧𝐚𝐛𝐞𝐥𝐥𝐞](https://telegra.ph/file/a639011d8a1d32ac93234.jpg)
# 𝔸𝐧𝐧𝐚𝐛𝐞𝐥𝐥𝐞 
...
Can be found on telegram as [𝔸𝐧𝐧𝐚𝐛𝐞𝐥𝐥𝐞](https://t.me/AnabelleRobot).

The Support group can be reached out to at [𝔸𝐧𝐧𝐚𝐛𝐞𝐥𝐥𝐞 Support](https://t.me/AnnabelleSupport), where you can ask for help about [𝔸𝐧𝐧𝐚𝐛𝐞𝐥𝐥𝐞](https://t.me/AnabelleRobot), discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
...
### Read these notes carefully before proceeding 
 - Edit any mentions of @AnnabelleSupport to your own support chat
...
```
  ...
  [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/FarhanArt/AnabelleRobot.git)
...
This file should be placed in your `𝔸𝐧𝐧𝐚𝐛𝐞𝐥𝐥𝐞` folder, alongside the `__main__.py` file. 
